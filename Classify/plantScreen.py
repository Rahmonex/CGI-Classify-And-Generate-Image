...
#Main Class
class PlantScreenWindow(QMainWindow):
    def __init__(self):
    ...
    def resetTimerAndUploadImage(self):
        ...
        fname = QFileDialog.getOpenFileName(self, "Upload the plant Picture", "", "Images (*.jpg *.png)")
        # Open the Image
    ...
    def connectButton(self):
        ...
        resultOfClassification = PredictWithCustomModel(pixmapPath,'Flowerdic','vgg16_flowersa4')
        self.openTimer()
