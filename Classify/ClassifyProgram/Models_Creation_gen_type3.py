...
# Load dataset and dataframe directory, must modify directory
...
# x_col = "" column in the csv containing files names
# y_col = ""  column in the csv containing label
# if allocation of xxxxx exceeds 10% of free system memory error add in flow_from_xxxx batch_size = (number less than 32)
traindata = traingen.flow_from_dataframe(dataframe, maindir, subset='training', class_mode='categorical',
                                         target_size=(224, 224))

testdata = valgen.flow_from_directory(dataframe, maindir, subset='validation', x_col="", y_col="",
