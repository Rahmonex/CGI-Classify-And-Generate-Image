...
from Classify.ClassifyProgram.PredictionFunctions import PredictWithSecondCustomModel
...
#Main Class
class ClothesScreenWindow(QMainWindow):
    def __init__(self):
    ...
    def resetTimerAndUploadImage(self):
        ...
        fname = QFileDialog.getOpenFileName(self, "Upload the clothes Picture", "", "Images (*.jpg *.png)")
        # Open the Image
    ...
    def connectButton(self):
        ...
        resultOfClassification = PredictWithSecondCustomModel(pixmapPath,'Clothesdic','vgg16_clothessa')
        self.openTimer()
